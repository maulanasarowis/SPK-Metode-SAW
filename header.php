...
<html lang="en">
  <head>
  	 <body style="background: #ffffff url(images/back5.jpg) center bottom fixed;">
    <meta charset="utf-8">
	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav">
			...
			<li><a href="rangking.php">Penilaian Karyawan</a></li>
		  ...
		  <div style="color: gray;
                ...
                float: right;
                font-size: 14px;"><?php echo "Tanggal : ".date("d-M-Y"); ?> 
        </div>
		</div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
	</nav>
